            ...
            <div className="flex items-center pr-4 pl-2 border-l border-gray-700/30 my-6">
              <div className="relative group/link">
                <a
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-xl bg-gray-800/50 hover:bg-blue-500/20 text-gray-400 hover:text-blue-400 transition-all border border-gray-700/50 hover:border-blue-500/30"
                >
