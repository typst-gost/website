...
import { MessageCircle, QrCode, Users, Sparkles, ExternalLink } from "lucide-react"
      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          <div className="flex flex-col max-w-xl text-left">
            <Heading as="h2" title="Сообщество Typst Gost" className="mb-6 lg:mb-8 text-left" />
            <p className="text-gray-400 text-lg leading-relaxed mb-8">
              Присоединяйтесь к нашему уютному сообществу в Telegram. Здесь мы обсуждаем 
              типографику, делимся готовыми шаблонами титульных листов ваших ВУЗов и 
              просто оперативно помогаем новичкам разобраться с ошибками.
            </p>
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              <a
                ...
                className="group relative inline-flex items-center justify-center gap-3 bg-[#2AABEE] hover:bg-[#229ED9] text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 shadow-[0_0_40px_-10px_#2AABEE] hover:shadow-[0_0_60px_-15px_#2AABEE] hover:-translate-y-1 w-full sm:w-auto"
              >
              ...
              <div className="flex bg-white/5 rounded-2xl p-1 mb-4">
                <button
                  ...
                  className={cn(
                    ...
                    activeTab === "stats" ? "bg-white/10 text-white shadow-sm" : "text-gray-400 hover:text-white hover:bg-white/5"
                  )}
                >
                ...
                <button
                  ...
                  className={cn(
                    "flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-medium transition-all duration-300",
                    activeTab === "qr" ? "bg-white/10 text-white shadow-sm" : "text-gray-400 hover:text-white hover:bg-white/5"
                  )}
                >
              ...
              <div className="relative overflow-hidden bg-white/5 border border-white/5 rounded-2xl aspect-square flex items-center justify-center">
                <AnimatePresence mode="wait">
                  {activeTab === "stats" && (
                    ...
                    >
                      <motion.div animate={isCelebrating ? { scale: [1, 1.1, 1], rotate: [0, -5, 5, 0] } : {}} className="relative">
                      ...
                      <div className="text-5xl font-bold text-white mb-2 tabular-nums tracking-tight">
                        {isLoading ? <span className="opacity-50">--</span> : <AnimatedNumber value={members} />}
                      </div>
                  ...
                  {activeTab === "qr" && (
                    ...
                    >
                      ...
                      <p className="text-gray-400 text-sm text-center max-w-50">Отсканируйте камерой телефона</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
