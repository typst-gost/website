      ...
      <div className="container mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <FeatureCard
            ...
            description="Шаблон сам форматирует, нумерует и оформляет все элементы отчёта по ГОСТ 7.32-2017. Забудьте о ручном оформлении — теперь всё делается автоматически."
          />
          <FeatureCard
